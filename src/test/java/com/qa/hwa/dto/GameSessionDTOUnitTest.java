...
public class GameSessionDTOUnitTest {
    private GameSessionDTO sessionWithId;
    private GameSessionDTO sessionWithoutId;
    private GameSessionDTO emptySession;
    private GameSessionDTO otherWithId;
    ...
    public void SetUp(){
        ...
        sessionWithId = new GameSessionDTO(1L, player1, "hello world", zeroTime, date);
        sessionWithoutId = new GameSessionDTO(player1, "hello world", zeroTime, date);
        emptySession = new GameSessionDTO();
        otherWithId = new GameSessionDTO(1L, player1, "hello world", zeroTime, date);
    }
